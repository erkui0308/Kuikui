...
live2d_settings['modelTexturesId']      = 15;           // 默认材质 ID，可在 F12 控制台找到
...
//看板娘样式设置
live2d_settings['waifuSize']            = '100x150';    // 看板娘大小，例如 '280x250', '600x535'
live2d_settings['waifuTipsSize']        = '100x35';     // 提示框大小，例如 '250x70', '570x150'
...
live2d_settings['waifuMinWidth']        = '280px';      // 面页小于 指定宽度 隐藏看板娘，例如 'disable'(禁用), '768px'
...
live2d_settings['screenshotCaptureName']= '融.png'; // 看板娘截图文件名，例如 'live2d.png'
